...
let product = "Akka.NET Roslyn Analyzers"
let authors = [ "Akka.NET Team" ]
let copyright = "Copyright © 2013-2016 Akka.NET Team"
let company = "Akka.NET Team"
let description = "Used to help support Akka.NET users and developers with common Akka-specific code issues"
let tags = ["akka";"actors";"actor";"model";"Akka";"concurrency";"roslyn"]
...
let slnFile = "./src/AkkaCodeAnalyser.sln"
...
Target "RunTests" <| fun _ ->  
    ...
    xUnit2
        (fun p -> { p with OutputDir = testOutput; ToolPath = xunitToolPath; MaxThreads = 1;  })
        xunitTestAssemblies
...
let createNugetPackages _ =
    ...
    for nuspec in !! "src/**/*.nuspec" do
        ...
        let nugetToolsDir = workingDir @@ @"tools/"
        let targetToolsDir = releaseDir @@ @"tools/"
        CopyDir nugetToolsDir targetToolsDir allFiles
        ...
        pack nugetDir NugetSymbolPackage.None //TODO: NuGet symbol packages do not work for this project at the moment
...
"BuildRelease" ==> "All"
//"RunTests" ==> "All" // doesn't work due to MEF issue with Roslyn 
"Nuget" ==> "All"
